...
namespace MVC_practice.Controllers
{
    ...
    {
        private readonly AdventureWorksLt4Context _context;

        public ProductsController(AdventureWorksLt4Context context)
        {
            _context = context;
        }
        ...
        {
            var adventureWorksLt4Context = _context.Products.Include(p => p.ProductCategory).Include(p => p.ProductModel);
            return View(await adventureWorksLt4Context.ToListAsync());
        }
